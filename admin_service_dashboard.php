    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                ...
                <Button class="greenbtn" onclick="openpart('adduser')"> <img class="icons" src="images/icon/add-user.png" width="30px" height="30px"/> ADD USER </Button>
                <Button class="greenbtn" onclick="openpart('userrecord')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/> USERS REPORT</Button>
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="Computing_&_IT"/>Computing & IT<input type="radio" name="branch" value="Space_Sciences"/>Space Sciences<input type="radio" name="branch" value="Medecine"/>Medecine<input type="radio" name="branch" value="Law"/>Law<input type="radio" name="branch" value="Physics"/>Physics
            <div style="margin-left:80px">
                <input type="radio" name="branch" value="Sports"/>Sports<input type="radio" name="branch" value="Economics"/>Economics<input type="radio" name="branch" value="Litterature"/>Litterature<input type="radio" name="branch" value="History"/>History<input type="radio" name="branch" value="Geography"/>Geography</div>
            </div>   
            ...
            <div class="rightinnerdiv">   
            <div id="adduser" class="innerright portion" style="display:none">
            <Button class="greenbtn" >ADD User</Button>
            <form action="adduserserver_page.php" method="post" enctype="multipart/form-data">
            ...
            <Button class="greenbtn" >USERS REPORT</Button>
